...
class OnlineHelper extends AsyncTask<String, Void, String>
{
    ...
    protected void onPreExecute()
    {
        ...
        json_url =      "http://10.9.40.50:80/webapp/getData.php";
        update_url =    "http://10.9.40.50:80/webapp/updateData.php";
        timeline_url =    "http://10.9.40.50:80/webapp/getTimeline.php";
        community_url =    "http://10.9.40.50:80/webapp/getCommunity.php";
